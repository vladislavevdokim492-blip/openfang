...
#### Client SDKs
- JavaScript SDK (`@clawforge/sdk`): full REST API client with streaming, TypeScript declarations
- Python client SDK (`clawforge_client`): zero-dependency stdlib client with SSE streaming
- Python agent SDK (`clawforge_sdk`): decorator-based framework for writing Python agents
...
- MCP server (exposes ClawForge tools via MCP protocol)
...
[0.1.0]: https://github.com/RightNow-AI/clawforge/releases/tag/v0.1.0
