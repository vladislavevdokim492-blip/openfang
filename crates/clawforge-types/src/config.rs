//! Configuration types for the ClawForge kernel.
...
impl Default for WebhookTriggerConfig {
    fn default() -> Self {
        Self {
            enabled: false,
            token_env: "CLAWFORGE_WEBHOOK_TOKEN".to_string(),
...
pub struct DockerSandboxConfig {
    ...
    pub image: String,
    /// Container name prefix. Default: "clawforge-sandbox".
...
impl Default for DockerSandboxConfig {
    fn default() -> Self {
        Self {
            ...
            container_prefix: "clawforge-sandbox".to_string(),
...
pub struct VaultConfig {
    ...
    pub enabled: bool,
    /// Custom vault file path (default: ~/.clawforge/vault.enc).
...
pub struct KernelConfig {
    /// ClawForge home directory (default: ~/.clawforge).
    pub home_dir: PathBuf,
    /// Data directory for databases (default: ~/.clawforge/data).
    ...
    /// Root directory for agent workspaces. Default: `~/.clawforge/workspaces`
    #[serde(default)]
...
impl Default for KernelConfig {
    fn default() -> Self {
        let home_dir = clawforge_home_dir();
        Self {
...
/// Resolve the ClawForge home directory.
///
/// Priority: `CLAWFORGE_HOME` env var > `~/.clawforge`.
fn clawforge_home_dir() -> PathBuf {
...
pub struct MatrixConfig {
    ...
    /// Bot user ID (e.g., "@clawforge:matrix.org").
    pub user_id: String,
...
pub struct IrcConfig {
    ...
    /// Channels to join (e.g., `["#clawforge", "#general"]`).
    #[serde(default, deserialize_with = "deserialize_string_or_int_vec")]
...
mod tests {
    ...
    fn test_validate_missing_env_vars() {
        ...
        config.channels.discord = Some(DiscordConfig {
            bot_token_env: "CLAWFORGE_TEST_NONEXISTENT_VAR_DC".to_string(),
            ..Default::default()
        });
        let warnings = config.validate();
