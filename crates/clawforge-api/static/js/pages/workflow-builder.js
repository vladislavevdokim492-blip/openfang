// ClawForge Visual Workflow Builder — Drag-and-drop workflow designer
'use strict';
...
function workflowBuilder() {
  return {
    ...
    async init() {
      ...
      try {
        var list = await ClawForgeAPI.get('/api/agents');
    ...
    async saveWorkflow() {
      ...
      try {
        await ClawForgeAPI.post('/api/workflows', {
          name: this.workflowName || 'untitled',
          description: this.workflowDescription || '',
          steps: steps
        });
        ClawForgeToast.success('Workflow saved!');
