...
const ETAG: &str = concat!("\"clawforge-", env!("CARGO_PKG_VERSION"), "\"");
...
/// GET /logo.png — Serve the ClawForge logo.
...
/// GET /favicon.ico — Serve the ClawForge favicon.
...
/// GET / — Serve the ClawForge Dashboard single-page application.
///
...
/// The embedded HTML/CSS/JS for the ClawForge Dashboard.
///
